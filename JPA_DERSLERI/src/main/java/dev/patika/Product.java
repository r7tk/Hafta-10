...
public class Product {
    ...
    // BİRDEN ÇOK toString çağırıldığında Hepsi birbirini sonsuz döngüye soktuğu için toStringler içinden herhangi birisinin toStringini silmek lazım
    // ", supplier=" + supplier + örnek olarak bu kısım diğer toStringi çağırıyor.
}
